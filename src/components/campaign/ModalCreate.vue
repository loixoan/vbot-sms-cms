...
const handleCreate = async (campaign: ICampaign) => {
  if (CampaignValidator(campaign)) {
    await createCampaign(campaign).then(async (res) => {
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content" id="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Thêm mới chiến dịch</h5>
        ...
        <div class="modal-body">
          ...
          <div class="modal-footer border-0 p-0 ">
            ...
            <button class="btn btn-primary"
                    @click="()=> handleCreate(campaign)">Lưu
            </button>
          </div>
        </div>
      </div>
