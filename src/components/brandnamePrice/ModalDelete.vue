...
import {deleteBrandnamePrice} from "@/services/brandnamePriceService";
...
const handleDelete = async (id:number) => {
  await deleteBrandnamePrice(id).then(async (res) => {
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content" id="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Xóa Giá Brandname có id là : {{id}}</h5>
